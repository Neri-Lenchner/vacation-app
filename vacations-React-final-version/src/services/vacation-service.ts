...
class VacationService {
    ...
    async addVacation(vacation: Vacation, imageFile?: File): Promise<Vacation> {
        ...
        try {
            ...
            console.error("addVacation failed:", error);
            throw error;
        }
    }
    ...
    async fetchTotal(): Promise<number> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("fetchTotal failed:", error);
            throw error;
        }
    }
    ...
    async getAllVacations(): Promise<Vacation[]> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("getAllVacations failed:", error);
            throw error;
        }
    }
    ...
    async fetchPage(pageNumber: number, limit = 10): Promise<Vacation[]> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("fetchPage failed:", error);
            throw error;
        }
    }
    ...
    public async getUsersFollowedVacations(id: number): Promise<Vacation[]> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("getUsersFollowedVacations failed:", error);
            throw error;
        }
    }
    ...
    public async getUpcomingVacations(): Promise<Vacation[]> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("getUpcomingVacations failed:", error);
            throw error;
        }
    }
    ...
    public async getActiveVacations(): Promise<Vacation[]> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("getActiveVacations failed:", error);
            throw error;
        }
    }
    ...
    async getVacationById(id: number): Promise<Vacation> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("getVacationById failed:", error);
            throw error;
        }
    }
    ...
    async updateVacation(id: number, vacation: Vacation, imageFile?: File): Promise<Vacation> {
        ...
        try {
            ...
            // eslint-disable-next-line no-console
            console.error("updateVacation failed:", error);
            throw error;
        }
    }
